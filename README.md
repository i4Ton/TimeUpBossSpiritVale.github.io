...
- **ออกห้อง**: เอาตัวเองออก ห้อง + ข้อมูลยังอยู่ กลับเข้าใหม่ด้วยรหัสได้
- **ลบห้อง**: ยืนยันแล้วลบทั้งห้อง + `records` + `members` ถาวร สมาชิกทุกคนหลุด
- ห้องที่ถูกทิ้งไว้ (ไม่มีใครกดลบ) → `sweepOldRooms()` เก็บกวาดหลังเงียบ 24 ชม.
